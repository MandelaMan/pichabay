  ...
  $(document).ready(function () {
      ...
      $(window).on("scroll load", function () {
        ...
        if ($(window).width() > "1099") {
          ...
          if ($(window).scrollTop() >= headerOffset) {
            ...
            $(
              ".utf-wrapper-utf-transparent-header-block-part #utf-header-container-block"
            )
              .addClass("cloned")
              .removeClass("utf-transparent-header-block unsticky");
          } else {
            $("#utf-header-container-block").removeClass("cloned");
            $(
              ".utf-wrapper-utf-transparent-header-block-part #utf-header-container-block"
            )
              .addClass("utf-transparent-header-block unsticky")
              .removeClass("cloned");
          }

          var transparentLogo = $("#utf-header-container-block #logo img").attr(
            "data-transparent-logo"
          );
          var stickyLogo = $("#utf-header-container-block #logo img").attr(
            "data-sticky-logo"
          );
          ...
          if (
            ...
            $("#utf-header-container-block.cloned #logo img").attr(
              "src",
              stickyLogo
            );
          }
          ...
          if (
            $(
              ".utf-wrapper-utf-transparent-header-block-part #utf-header-container-block"
            ).hasClass("utf-transparent-header-block")
          ) {
            $("#utf-header-container-block #logo img").attr(
              "src",
              transparentLogo
            );
          }
    ...
    $(window).on("load", function () {
      $(".button.utf-button-sliding-icon")
        .not(".task-listing .button.utf-button-sliding-icon")
        .each(function () {
    ...
    function wrapperHeight() {
      ...
      $(
        ".full-page-content-container, .utf-dashboard-content-container-aera, .utf-dashboard-sidebar-item-inner, .utf-dashboard-container-aera, .full-page-container"
      ).css({
        height: windowHeight,
      });
    ...
    function fullPageScrollbar() {
      $(".full-page-sidebar-inner, .utf-dashboard-sidebar-item-inner").each(
        function () {
          var headerHeight = $("#utf-header-container-block").outerHeight();
          var windowHeight = $(window).outerHeight() - headerHeight;
          var sidebarContainerHeight = $(this)
            .find(".utf-sidebar-container-aera, .utf-dashboard-nav-container")
            .outerHeight();
    ...
    $(".utf-dashboard-responsive-trigger-item").on("click", function (e) {
      ...
      $(".utf-dashboard-responsive-trigger-item .hamburger").toggleClass(
        "is-active"
      );
    });
    ...
    $(".photo-box, .utf-photo-section-block, .utf-video-container-block").each(
      function () {
        var photoBox = $(this);
    ...
    $(".login-tab").on("click", function (event) {
      ...
      $("body")
        .find('.utf-popup-tabs-nav-item a[href="#login"]')
        .parent("li")
        .click();
    });
